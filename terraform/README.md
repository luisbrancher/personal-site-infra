...
```
.
├── provider.tf     # Terraform backend, AWS provider, default tags
├── variables.tf    # All configurable values
├── network.tf      # VPC, subnet, IGW, route table, security group
├── ec2.tf          # AMI data source, key pair, EC2 instance
├── iam.tf          # IAM group, user, and least-privilege policy
...
git clone https://https://github.com/luisbrancher/personal-site-infra
